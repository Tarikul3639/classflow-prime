 ...
 */
export function getAccessTokenFromCookies(req: { cookies?: Record<string, string> }): string | null {
 ...
 */
export function getRefreshTokenFromCookies(req: { cookies?: Record<string, string> }): string | null {
 ...
 */
export function getAuthTokensFromCookies(req: { cookies?: Record<string, string> }): IAuthTokens | null {
