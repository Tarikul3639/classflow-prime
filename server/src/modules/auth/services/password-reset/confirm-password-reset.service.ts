...
//         const user: UserDocument | null = await this.userModel.findOne({ email }).select('+passwordResetCode +passwordResetExpiresAt +passwordResetAttempts +lastPasswordResetRequestAt');
