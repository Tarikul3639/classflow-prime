    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative">
        <select
          {...props}
          className={clsx(
            "w-full h-10 sm:h-11 px-4 lg:px-5 pr-10 rounded-lg border bg-[#f8fafc] outline-none transition-all duration-200 text-[13px] md:text-sm focus:ring-2 focus:ring-offset-0 focus-visible:ring-2 focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 appearance-none cursor-pointer",
            error
        ...
        <ChevronDown
          size={16}
          className="absolute right-4 top-1/2 -translate-y-1/2 text-[#617789] pointer-events-none"
        />
      </div>
