  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <textarea
        {...props}
        className={clsx(
          "w-full min-h-25 px-4 py-3 lg:px-5 rounded-lg border bg-[#f8fafc] outline-none transition-all duration-200 text-[13px] md:text-sm focus:ring-2 focus:ring-offset-0 focus-visible:ring-2 focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 resize-y",
          error
