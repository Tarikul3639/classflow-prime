    ...
    <div className="flex flex-col min-h-screen bg-slate-50">
      ...
      <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-lg border-b border-slate-200 px-4 py-3">
        <div className="flex items-center gap-4">
          <div
            className="size-10 rounded-full ring-2 ring-primary/20 bg-cover bg-center"
            style={{
              backgroundImage:
          ...
          <div className="flex-1">
            ...
            <p className="text-xs font-medium text-slate-600">ClassFlow v2.0</p>
          </div>
          <div className="flex items-center gap-3">
            <button className="flex items-center justify-center size-10 rounded-full bg-slate-100 text-slate-900 hover:bg-primary/10 transition-colors">
              <Search size={20} />
            </button>
            <button className="relative flex items-center justify-center size-10 rounded-full bg-slate-100 text-slate-900 hover:bg-primary/10 transition-colors">
              <Bell size={20} />
